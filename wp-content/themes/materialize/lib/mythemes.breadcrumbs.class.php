...
class mythemes_breadcrumbs
{
	static function home()
    {
        ...
        $rett .= '<a href="' . esc_url( home_url( '/' ) ) . '" title="' . esc_attr( get_theme_mod( 'mythemes-home-link-description' , __( 'go to home' , 'materialize' ) ) ) . '">';
        $rett .= '<i class="icon-home"></i> <span>' . esc_html( get_theme_mod( 'mythemes-home-label' , __( 'Home' , 'materialize' ) ) ) . '</span>';
        $rett .= '</a>';
        $rett .= '</li>';
